        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            <div className={styles.brandSection}>
              ...
              <p>Лучшее место для отдыха и вкусной еды</p>
              <div className={styles.social}>
                <a target="_blank" href="https://wa.me/79994006000" aria-label="WhatsApp" className={styles.socialLink}>
                  <svg
                ...
                <a target="_blank" href="https://www.instagram.com/key_bar_95/" aria-label="Instagram" className={styles.socialLink}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                ...
                <a target="_blank" href="https://t.me/79994006000" aria-label="Telegram" className={styles.socialLink}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
