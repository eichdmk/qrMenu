...
export const TagIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20.59 13.41L13.42 20.58C13.2343 20.766 13.0137 20.9135 12.7709 21.0141C12.5281 21.1148 12.2678 21.1666 12.005 21.1666C11.7422 21.1666 11.4819 21.1148 11.2391 21.0141C10.9963 20.9135 10.7757 20.766 10.59 20.58L2 12V2H12L20.59 10.59C20.961 10.961 21.1666 11.4696 21.1666 12C21.1666 12.5304 20.961 13.039 20.59 13.41Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
export const PackageIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16.5 9.4L9.5 4.21M2 16.5L9.5 21.79L17 16.5M2 12.5L9.5 7.71L17 12.5M22 7.5L9.5 2.21L2 7.5L9.5 12.79L22 7.5Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const ShoppingCartIcon = ({ size = 20, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CashIcon = ({ size = 28, primary = '#0f766e', secondary = '#bbf7d0' }) => (
  <svg width={size} height={size * 0.75} viewBox="0 0 32 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="1.5" y="4.5" width="29" height="15" rx="3" fill={secondary} stroke={primary} strokeWidth="1.5"/>
    <rect x="6" y="7.5" width="20" height="9" rx="2.5" stroke={primary} strokeOpacity="0.6" strokeWidth="1.2"/>
    <circle cx="16" cy="12" r="3.2" stroke={primary} strokeWidth="1.4" fill="white" fillOpacity="0.7"/>
    <path d="M12.5 4.5L9 1.5" stroke={primary} strokeWidth="1.2" strokeLinecap="round"/>
    <path d="M19.5 19.5L23 22.5" stroke={primary} strokeWidth="1.2" strokeLinecap="round"/>
  </svg>
);

export const CardIcon = ({ size = 28, primary = '#0f766e', secondary = '#cffafe' }) => (
  <svg width={size} height={size * 0.7} viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="1.5" y="3" width="29" height="17" rx="3.5" fill={secondary} stroke={primary} strokeWidth="1.5"/>
    <rect x="3.5" y="8" width="25" height="3" fill={primary} fillOpacity="0.25" rx="1.2"/>
    <rect x="18" y="14" width="7.5" height="3.5" rx="1.2" fill="#0ea5e9" fillOpacity="0.6"/>
    <rect x="8.5" y="14" width="7" height="3.5" rx="1.2" fill="#38bdf8" fillOpacity="0.45"/>
    <circle cx="11" cy="7" r="1" fill={primary} fillOpacity="0.8"/>
  </svg>
);
